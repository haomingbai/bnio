 ...
 */
class BNIO_EXPORT kqueue_helper {
 public:
  ...
  [[nodiscard]] const bnio::base::event* events() const noexcept {
    return events_.data();
  }
  ...
  [[nodiscard]] const bnio::base::event& event(
 ...
 private:
  ...
  std::array<bnio::base::event, 2> events_{};
...
#endif  // BNIO_ASYNC_IO_BSD_KQUEUE_HELPER_H_
