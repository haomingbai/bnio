 ...
 * @brief io_uring positioned file read/write operations on random access
 * files.
 */

#pragma once
#ifndef BNIO_ASYNC_IO_LINUX_IO_URING_OPERATIONS_RANDOM_ACCESS_FILE_H_
#define BNIO_ASYNC_IO_LINUX_IO_URING_OPERATIONS_RANDOM_ACCESS_FILE_H_
...
class io_uring_random_access_read_operation
 ...
 public:
  ...
  io_uring_random_access_read_operation(io_uring_context& context,
                                        ...
                                        std::uint64_t offset, Receiver receiver)
...
#endif  // BNIO_ASYNC_IO_LINUX_IO_URING_OPERATIONS_RANDOM_ACCESS_FILE_H_
