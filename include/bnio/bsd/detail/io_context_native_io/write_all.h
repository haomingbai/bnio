#ifndef BNIO_BSD_DETAIL_IO_CONTEXT_NATIVE_IO_WRITE_ALL_H_
#ifndef BNIO_BSD_IO_CONTEXT_H_
#include <bnio/bsd/io_context.h>
#else
#define BNIO_BSD_DETAIL_IO_CONTEXT_NATIVE_IO_WRITE_ALL_H_
...
#endif  // BNIO_BSD_DETAIL_IO_CONTEXT_NATIVE_IO_WRITE_ALL_H_
