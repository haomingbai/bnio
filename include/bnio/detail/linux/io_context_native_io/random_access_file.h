 ...
 * @brief Linux native positioned file I/O models.
 */

#ifndef BNIO_DETAIL_LINUX_IO_CONTEXT_NATIVE_IO_RANDOM_ACCESS_FILE_H_
#ifndef BNIO_DETAIL_POSIX_IO_CONTEXT_CLASS_H_
#include <bnio/io_context.h>
#else
#define BNIO_DETAIL_LINUX_IO_CONTEXT_NATIVE_IO_RANDOM_ACCESS_FILE_H_
...
class random_access_read_model {
 public:
  ...
  random_access_read_model(async_io::random_access_file file,
                           mutable_buffer buffer, std::uint64_t offset) noexcept
...
#endif  // BNIO_DETAIL_LINUX_IO_CONTEXT_NATIVE_IO_RANDOM_ACCESS_FILE_H_
