/**
 * @file descriptor_file_io.h
 * @brief Streaming descriptor file I/O operation sender factories.
 */

#ifndef BNIO_DETAIL_POSIX_IO_CONTEXT_DESCRIPTOR_FILE_IO_H_
#ifndef BNIO_DETAIL_POSIX_IO_CONTEXT_CLASS_H_
#include <bnio/io_context.h>
#else
#define BNIO_DETAIL_POSIX_IO_CONTEXT_DESCRIPTOR_FILE_IO_H_
...
#endif  // BNIO_DETAIL_POSIX_IO_CONTEXT_DESCRIPTOR_FILE_IO_H_
