/**
 * @file random_access_write_all.h
 * @brief Random access file write-all operation state.
 */

#ifndef BNIO_DETAIL_POSIX_IO_CONTEXT_RANDOM_ACCESS_WRITE_ALL_H_
#ifndef BNIO_DETAIL_POSIX_IO_CONTEXT_CLASS_H_
#include <bnio/io_context.h>
#else
#define BNIO_DETAIL_POSIX_IO_CONTEXT_RANDOM_ACCESS_WRITE_ALL_H_

namespace bnio::detail {

/**
 * State for a positioned write-all operation on a random access file.
 *
...
class random_access_write_all_state {
 public:
  ...
  random_access_write_all_state(io_context& context,
...
#endif  // BNIO_DETAIL_POSIX_IO_CONTEXT_RANDOM_ACCESS_WRITE_ALL_H_
