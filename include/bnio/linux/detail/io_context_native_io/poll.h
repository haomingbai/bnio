#ifndef BNIO_LINUX_DETAIL_IO_CONTEXT_NATIVE_IO_POLL_H_
#ifndef BNIO_LINUX_IO_CONTEXT_H_
#include <bnio/linux/io_context.h>
#else
#define BNIO_LINUX_DETAIL_IO_CONTEXT_NATIVE_IO_POLL_H_
...
#endif  // BNIO_LINUX_DETAIL_IO_CONTEXT_NATIVE_IO_POLL_H_
