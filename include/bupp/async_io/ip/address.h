 ...
 */
[[nodiscard]] BUPP_EXPORT std::optional<address> make_address(
    std::string_view text);

/**
 * Parses an IPv4 or IPv6 address string.
 */
[[nodiscard]] BUPP_EXPORT std::optional<address> make_addr(
    std::string_view text);

/**
 * Parses an IPv4 address string.
 */
[[nodiscard]] BUPP_EXPORT std::optional<address> make_v4_address(
    std::string_view text);
...
#endif  // BUPP_ASYNC_IO_IP_ADDRESS_H_
