#ifndef BUPP_BSD_DETAIL_IO_CONTEXT_NATIVE_IO_TIMER_WAIT_H_
#ifndef BUPP_BSD_IO_CONTEXT_H_
#include <bupp/bsd/io_context.h>
#else
#define BUPP_BSD_DETAIL_IO_CONTEXT_NATIVE_IO_TIMER_WAIT_H_
...
#endif  // BUPP_BSD_DETAIL_IO_CONTEXT_NATIVE_IO_TIMER_WAIT_H_
