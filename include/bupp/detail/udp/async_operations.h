#pragma once
#ifndef BUPP_DETAIL_UDP_ASYNC_OPERATIONS_H_
#define BUPP_DETAIL_UDP_ASYNC_OPERATIONS_H_
  ...
  udp_receive_operation(scheduler_type scheduler,
    ...
    child_operation_.emplace_from([this] {
      return bexec::connect(
          make_child_sender(scheduler_, socket_, bupp::buffer(holder_.view()),
                            endpoint_, flags_),
          child_receiver(*this));
    });
  }
...
#endif  // BUPP_DETAIL_UDP_ASYNC_OPERATIONS_H_
