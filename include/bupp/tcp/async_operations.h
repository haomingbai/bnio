...
template <class Scheduler, class Buffer>
auto socket::async_read_direct(Scheduler scheduler, Buffer&& buffer,
                               int flags) {
  auto holder =
      detail::make_mutable_buffer_holder(std::forward<Buffer>(buffer));
  using scheduler_type = std::remove_cvref_t<Scheduler>;
...
template <class Scheduler, class Buffer>
auto socket::async_read_some_direct(Scheduler scheduler, Buffer&& buffer,
                                    int flags) {
  auto holder =
      detail::make_mutable_buffer_holder(std::forward<Buffer>(buffer));
  using scheduler_type = std::remove_cvref_t<Scheduler>;
...
template <class Scheduler, class Buffer>
auto socket::async_write_direct(Scheduler scheduler, Buffer&& buffer,
                                int flags) {
  auto holder = detail::make_const_buffer_holder(std::forward<Buffer>(buffer));
  using scheduler_type = std::remove_cvref_t<Scheduler>;
  using holder_type = decltype(holder);
...
template <class Scheduler, class Buffer>
auto socket::async_write_some_direct(Scheduler scheduler, Buffer&& buffer,
                                     int flags) {
  auto holder = detail::make_const_buffer_holder(std::forward<Buffer>(buffer));
  using scheduler_type = std::remove_cvref_t<Scheduler>;
  using holder_type = decltype(holder);
...
template <class Scheduler>
auto socket::async_connect_direct(Scheduler scheduler,
...
template <class Scheduler>
auto acceptor::async_accept_direct(Scheduler scheduler, int flags) {
  using scheduler_type = std::remove_cvref_t<Scheduler>;
